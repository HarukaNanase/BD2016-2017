...
FROM Oferta as O
WHERE( O.codigo = new.codigo and 
O.morada = new.morada and
new.data_fim > new.data_inicio and (
new.data_fim between O.data_inicio AND O.data_fim OR
new.data_inicio between O.data_inicio and O.data_fim)
OR (O.data_fim between new.data_inicio AND new.data_fim OR O.data_inicio between new.data_inicio and new.data_fim)))
AS B )
into exist;
