<html>
    <body>
    <h3>Criar Reserva - Select Oferta para reservar</h3>
		<?php
			try{		
				require 'bd_init.php';			
				...
				foreach($result as $row)
				{
					...
					echo("<td><a href=\"cria_reserva_p2.php?morada={$row['morada']}&codigo={$row['codigo']}&data_inicio={$row['data_inicio']}\">Select</a></td>\n");
					echo("</tr>\n");
				}
				echo("</table>\n");			
				$db = null;
