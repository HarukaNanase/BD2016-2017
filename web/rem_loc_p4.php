									...
									<div class="w-clearfix w-col w-col-3">
										<div class="sign-in signup">
											<div class="w-clearfix w-form">
												<form class='form signup' action='rem_loc_pos.php' data-name='remove_local' id='wf-form-remove_local' method='post' name='wf-form-remove_local'>
													...
													<select class="text-field w-select" data-name="morada" id="morada" name="morada" readonly><option value="<?=$_POST['morada']?>"><?=$_POST['morada']?></option></select>
													<select class="text-field w-select" data-name="codigo_espaco" id="codigo_espaco" name="codigo_espaco" readonly><option value="<?=$_POST['codigo']?>"><?=$_POST['codigo']?></option></select>
													<select class="text-field w-select" data-name="codigo" id="codigo" name="codigo">
													<optgroup label="Postos de Trabalho Existentes">
														<?php
															$type = $_POST['type'];
															require 'bd_init.php';
															$sql    = "SELECT posto.codigo FROM posto WHERE posto.morada='{$_POST['morada']}' and posto.codigo_espaco='{$_POST['codigo']}';";
															$result = $db->query($sql);
